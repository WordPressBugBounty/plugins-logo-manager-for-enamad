...
class enamad_widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        echo enamadlogo_wp_kses( $before_widget );
        echo enamadlogo_wp_kses( $before_title . $title . $after_title );
        $print_output = true;
        $is_widget    = true;
        ...
        echo enamadlogo_wp_kses( $after_widget );
    }
        ...
        public function vc_enamad_html( $atts ) {
            ...
            $html = '
				<div class="vc-infobox-wrap">
					...
					<h2 class="vc-infobox-title">' . esc_html( $title ) . '</h2>
